...
def prepare_image(img, processor):
    ...
    img.thumbnail(new_size, Image.LANCZOS) # Shrink largest dimension to fit new size
    img = img.resize(new_size, Image.LANCZOS) # Stretch smaller dimension to fit new size
